...
module.exports = {  
  ...
  reloadInstaLikes: async function reloadInstaLikes(sheetName){
    try {
      ...
      const userClientDoc = new GoogleSpreadsheet(ciceroKey.dbKey.userDataID, googleAuth);//Google Authentication for user client DB
