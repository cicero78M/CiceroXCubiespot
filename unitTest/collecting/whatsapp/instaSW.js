...
module.exports = {
  ...
  instaSW: async function waStoryInsta(waNumber, shortcode){
    ...
    if (shortcode !== null){
      let instaPostResponse = await instaAPI.instaPostInfoAPI(shortcode);
      ...
      if(hasSheetName){
        ...
        let responseInstaPost = await instaAPI.instaPostAPI(instaOfficial);
        ...
        let userResponse = await sheetDoc.sheetDoc(ciceroKey.dbKey.userDataID, clientName);
