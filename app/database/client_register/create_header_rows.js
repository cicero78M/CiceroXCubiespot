...
export async function createSheetHeader(
    clientName, 
    sheetID
) {
    ...
    return new Promise(
        async (
            ...
            try {
                ...
                const instaLikesUsernameDoc = new GoogleSpreadsheet(
                    sheetID, 
                    googleAuth
                ); //Google Authentication for instaLikes Username DB
                ...
                await instaLikesUsernameSheet.resize({
                    rowCount: 1000, 
                    columnCount: 1501 
                });
                ...
                await instaLikesUsernameSheet.setHeaderRow(
                    headersRows, 
                    1
                );
