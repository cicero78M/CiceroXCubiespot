          ...
          if (hasContent) {
            ...
            if (hasShortcode) {
              ...
              for (let i = 0; i < itemByDay.length; i++) {
                ...
                dataObject.COMMENT_COUNT = encrypted((itemByDay[i].comment_count).toString());
                dataObject.LIKE_COUNT = encrypted((itemByDay[i].like_count).toString());
                dataObject.PLAY_COUNT = encrypted((itemByDay[i].play_count).toString());
